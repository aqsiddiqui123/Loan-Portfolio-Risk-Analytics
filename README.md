...
1. Which borrower characteristics are associated with higher observed default rates?
2. Which loan products and employment groups appear riskier?
3. Which combinations of borrower characteristics create the highest-risk segments?
4. How should a lender prioritize underwriting review and portfolio monitoring based on these findings?
...
This project is an educational portfolio analysis.

The findings, risk segments, and thresholds shown here should not be interpreted as production underwriting rules or lending recommendations without further validation, larger samples, and appropriate model-governance review.
